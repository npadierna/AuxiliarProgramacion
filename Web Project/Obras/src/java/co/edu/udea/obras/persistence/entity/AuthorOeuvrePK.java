 ...
 */
@Embeddable()
public class AuthorOeuvrePK implements Serializable {
    ...
    public boolean equals(Object object) {
        if (!(object instanceof AuthorOeuvrePK)) {

            return (false);
        }

        AuthorOeuvrePK other = (AuthorOeuvrePK) object;
    ...
    public String toString() {
        ...
        return ("co.edu.udea.obras.persistence.entity.AuthorOeuvrePK[ oeuvreTypeId="
